...
#python ../train/train_mpe.py --env_name MPE --algorithm_name rmappo --experiment_name check --scenario_name simple_reference --num_agents 2 --num_landmarks 3 --seed 1  --n_training_threads 1 --n_rollout_threads 128 --num_mini_batch 1 --episode_length 25 --num_env_steps 2000000 --ppo_epoch 15 --gain 0.01 --lr 7e-4 --critic_lr 7e-4 --wandb_name "xxx" --user_name "yuchao" --share_policy