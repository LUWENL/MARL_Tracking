...
from .model_utils import str2datetime
...
def generate_random_omega(max_omega=METADATA['max_omega']):
    omega_x = random.uniform(-max_omega, max_omega)
    omega_y = random.uniform(-max_omega, max_omega)
    omega_z = random.uniform(-max_omega, max_omega)
...
if __name__ == '__main__':
    ...
    eci = np.array([-5178.488718, 4281.498009, 1469.965300])
    lla = np.array([82.441, 24.488, 10.668000])

    datetime = str2datetime('1 Oct 2023 04:00:00.000')

    # print(lla2eci(lla, datetime))
    # print(eci2lla(eci, datetime))
